      ...
      <div className="container-fluid px-4">
        ...
        >
          ...
          <div className="offcanvas-body">
            ...
            {/* MAIN NAV ITEMS */}
            <ul className="navbar-nav align-items-lg-center gap-lg-4 mx-auto">
              ...
              <li className="nav-item dropdown">
                ...
                <ul
                  ...
                  aria-labelledby="dropdownCollections"
                >
                  <li>
                    <a className="dropdown-item" href="summer.html">
                      Summer Collections
                    </a>
                  </li>

                  <li>
                    <a className="dropdown-item" href="winter.html">
                      Winter Collections
                    </a>
                  </li>

                  <li>
                    <a className="dropdown-item" href="casual.html">
                      Casual Collections
                    </a>
                  </li>

                  <li>
                    <a className="dropdown-item" href="party.html">
                      Party Collections
                    </a>
                  </li>
                </ul>
            ...
            <ul className="navbar-nav align-items-lg-center gap-lg-3">
              ...
              {/* ACCOUNT */}
              <li className="nav-item dropdown header-account-item">
                ...
                <ul
                  className="dropdown-menu dropdown-menu-end account-profile-menu"
              ...
              <li className="nav-item">
                <a
                  href="#search"
                  className="nav-link d-flex align-items-center px-2"
                >
                  <svg
                    width="22"
                    height="22"
